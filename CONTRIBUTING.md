...
## Finding first issue
Go to [issues tab](https://github.com/medibloc/wallet/issues) and look for 

*✏️ `good first issue`* - it is a label for tasks that are perfect for people who want to start with MediBloc wallet.

## Reporting issues

 1. Check if problem already exist in [issues tab](https://github.com/medibloc/wallet/issues)
 2. If not, create a new [issue](https://github.com/medibloc/wallet/issues/new)
...
##### Before creating PR make use that:
 ...
 - The PR follows our [Test guide](/medibloc/wallet/blob/development/docs/TEST_GUIDE.md)
 - The PR follows our [CSS guide](/medibloc/wallet/blob/development/docs/CSS_GUIDE.md)
