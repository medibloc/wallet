  ...
  if (type === 'register') {
    ...
    return (
      <div className={styles.footer}>
        <h6> {t('or')} </h6>
        <div className={`${styles.wrapper}`}>
          <a className={`${styles.register}`} onClick={() => history.replace(`${routes.notSupportFeature.path}`)}>{t('Sign up')}</a>
          <span className={`${styles.divider}`}> | </span>
          <a className={`${styles.restore}`} onClick={() => history.replace(`${routes.restore.path}`)}>{t('Restore an account from a backup')}</a>
        </div>
      </div>
    ...
    return (
      <div className={styles.footer}>
        ...
        <div className={`${styles.wrapper}`}>
          <a className={`${styles.login}`} onClick={() => history.replace(`${routes.login.path}`)}>{t('Sign in')}</a>
          <span className={`${styles.divider}`}> | </span>
          <a className={`${styles.register}`} onClick={() => history.replace(`${routes.notSupportFeature.path}`)}>{t('Create new wallet ID')}</a>
        </div>
      </div>
    );
  }
